...
- [ ] E1【P0】URL 模板通用 `{{js}}` 表达式执行（AnalyzeUrl.kt:129-156；search.rs 仅字面替换）
- [ ] E2 `page` 以 Number 注入 JS 变量（现为字符串，page+1="11"）
...
- [ ] E8 字段清洗：formatBookName/formatBookAuthor/wordCountFormat/kind 多值逗号拼接（BookList.kt:168-186）
