...
implements CURD<Bookmark> {
    ...
    public Bookmark convertToEntity(@NotNull JsonObject var1) {
        return (Bookmark)CURD.DefaultImpls.convertToEntity((CURD)this, (JsonObject)var1);
    }

    @NotNull
    public Bookmark[] convertToEntityList(@NotNull String var1) {
        return (Bookmark[])CURD.DefaultImpls.convertToEntityList((CURD)this, (String)var1);
    }
