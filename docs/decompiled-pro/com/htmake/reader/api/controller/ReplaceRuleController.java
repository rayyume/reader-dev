...
implements CURD<ReplaceRule> {
    ...
    public ReplaceRule convertToEntity(@NotNull JsonObject var1) {
        return (ReplaceRule)CURD.DefaultImpls.convertToEntity((CURD)this, (JsonObject)var1);
    }

    @NotNull
    public ReplaceRule[] convertToEntityList(@NotNull String var1) {
        return (ReplaceRule[])CURD.DefaultImpls.convertToEntityList((CURD)this, (String)var1);
    }
