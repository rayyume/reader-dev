...
> 状态：**已成型（v5.2.2）**——全部视图与后端联调完成，见文末「已实现进度」。本文 §1–§6 为技术选型与设计要求（§2 中部分要求尚未落地，见 §7 标注）。
...
> 更新于 2026-08-09（v5.2.2——KindleMOBI 附加数据清理与 PalmDoc 重叠回引修复；阅读中换源与移动端宽度自适应完成，全量视图与后端联调）
